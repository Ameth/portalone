...
function CrearObtenerDirRuta($pRuta){//Crear y retornar la carpeta de la ruta que se pase
	$carp_anexos=$pRuta;
...
function DescargarFileAPI($pNombreWS,$method='GET'){//Descargar archivos mediante la API
...
function AuthJWT($pUser, $pPassword, $pEndpoint='Login', $pParametros=''){//Obtener token JWT mediante la API
