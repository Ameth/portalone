...
if(isset($_POST['P'])&&($_POST['P']==32)){
	...
	try{
		...
		$ParamInsLlamada=array(
			...
			"'".$_POST['CDU_NombreContacto']."'",
			"'".$_POST['CDU_TelefonoContacto']."'",
			"'".$_POST['CDU_CargoContacto']."'",
			"'".$_POST['CDU_CorreoContacto']."'",
...
function ValidarCampos(){
	...
	if(EstadoServicio.value=='2' || EstadoServicio.value=='3'){
			...
			<div class="col-lg-12">   		
				...
				<?php include("includes/spinner.php"); ?>
					<div class="form-group">
						<div class="col-lg-6">
							<a href="sapdownload.php?id=<?php echo base64_encode('14');?>&type=<?php echo base64_encode('2');?>&DocKey=<?php echo base64_encode($row['ID_LlamadaServicio']);?>" target="_blank" class="btn btn-outline btn-success"><i class="fa fa-download"></i> Descargar formato</a>
              ...
              <form action="llamada_servicio.php" method="post" class="form-horizontal" enctype="multipart/form-data" id="CrearLlamada">
				...
				<div class="form-group">
					...
					<label class="col-lg-1 control-label">Sucursal</label>
				  	<div class="col-lg-3">
                    	<select name="SucursalCliente" class="form-control m-b select2" id="SucursalCliente" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
						  <?php if(($type_llmd==0)||($sw_error==1)){?><option value="">Seleccione...</option><?php }?>
				...
				<div class="form-group">					
					<label class="col-lg-1 control-label">ID servicio</label>
				  	<div class="col-lg-8">
                    	<select name="ArticuloLlamada" required class="form-control m-b select2" id="ArticuloLlamada" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
				...
				<div class="form-group">
					<label class="col-xs-12"><h3 class="bg-muted p-xs b-r-sm"><i class="fa fa-info-circle"></i> Información de llamada</h3></label>
				</div>
				<?php if($type_llmd==1){?>
				<div class="form-group">
					<label class="col-lg-1"><span class="pull-right">Ticket</span></label>
					<div class="col-lg-1">
                    	<p><?php echo $row['DocNum'];?></p>
               	  	</div>
					<label class="col-lg-1"><span class="pull-right">Creada por</span></label>
					<div class="col-lg-2">
                    	<p><?php echo $row['UsuarioCreacion'];?></p>
               	  	</div>
					<label class="col-lg-1"><span class="pull-right">Fecha creación</span></label>
					<div class="col-lg-1">
                    	<p><?php echo $row['FechaHoraCreacionLLamada']->format("Y-m-d H:i:s");?></p>
               	  	</div>
					<label class="col-lg-1"><span class="pull-right">Actualizado por</span></label>
					<div class="col-lg-2">
                    	<p><?php echo $row['UsuarioActualizacion'];?></p>
               	  	</div>
					<label class="col-lg-1"><span class="pull-right">Fecha actualización</span></label>
					<div class="col-lg-1">
                    	<p><?php echo $row['FechaActualizacion']." ".$row['HoraActualizacion'];?></p>
               	  	</div>
				</div>
				<?php }?>
				<div class="form-group">
					...
					<div class="col-lg-8">
                    	<input autocomplete="off" name="AsuntoLlamada" type="text" required="required" class="form-control" id="AsuntoLlamada" maxlength="150" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "readonly='readonly'";}?> value="<?php if(($type_llmd==1)||($sw_error==1)){echo $row['AsuntoLlamada'];}else{ echo "PLAN DE CONTROL DE PLAGAS";}?>">
               	  	</div>
					<label class="col-lg-1 control-label">Tipo tarea</label>
				  	<div class="col-lg-2">
                    	<select name="TipoTarea" class="form-control m-b" id="TipoTarea" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
				...
				<div class="form-group">
					<label class="col-lg-1 control-label">Tipo llamada</label>
				  	<div class="col-lg-2">
                    	<select name="TipoLlamada" class="form-control m-b" required="required" id="TipoLlamada" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
								<option value="">Seleccione...</option>
					...
					<div class="col-lg-3">
                    	<select name="TipoProblema" class="form-control m-b" id="TipoProblema" required <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
								<option value="">Seleccione...</option>
					...
					<div class="col-lg-3">
                    	<select name="SubTipoProblema" class="form-control m-b" required id="SubTipoProblema" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
								<option value="">Seleccione...</option>
				...
				<div class="form-group">
					...
					<div class="col-lg-2">
                    	<select name="Series" class="form-control m-b" id="Series" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
					...
					<label class="col-lg-1 control-label">Cola</label>
				  	<div class="col-lg-4">
                    	<select name="ColaLlamada" class="form-control m-b" id="ColaLlamada" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
								<option value="">Seleccione...</option>
						</select>
               	  	</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-4">
                    	<select name="EmpleadoLlamada" class="form-control m-b select2" id="EmpleadoLlamada" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
					...
					<div class="col-lg-2">
                    	<select name="EstadoLlamada" class="form-control m-b" id="EstadoLlamada" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
				...
				<div class="form-group">
					<label class="col-lg-1 control-label">Comentario</label>
				  	<div class="col-lg-8">
                    	<textarea name="ComentarioLlamada" rows="7" class="form-control" id="ComentarioLlamada" type="text" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "readonly='readonly'";}?>><?php if(($type_llmd==1)||($sw_error==1)){echo $row['ComentarioLlamada'];}?></textarea>
               	  	</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12"><h3 class="bg-muted p-xs b-r-sm"><i class="fa fa-edit"></i> Información adicional</h3></label>
				</div>
				<div class="form-group">
					<label class="col-lg-1 control-label">Estado de servicio</label>
					<div class="col-lg-3">
						<select name="CDU_EstadoServicio" class="form-control m-b" id="CDU_EstadoServicio" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?> required>
						  <?php while($row_EstServLlamada=sqlsrv_fetch_array($SQL_EstServLlamada)){?>
								<option value="<?php echo $row_EstServLlamada['IdEstadoServicio'];?>" <?php if(($row_EstServLlamada['IdEstadoServicio']==0)||(isset($row['CDU_EstadoServicio']))&&(strcmp($row_EstServLlamada['IdEstadoServicio'],$row['CDU_EstadoServicio'])==0)){ echo "selected=\"selected\"";}?>><?php echo $row_EstServLlamada['DeEstadoServicio'];?></option>
						  <?php }?>
						</select>
					</div>
					<label class="col-lg-1 control-label">Cancelado por</label>
					<div class="col-lg-3">
						<select name="CDU_CanceladoPor" class="form-control m-b" id="CDU_CanceladoPor" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?> required>
				...
				<div class="form-group">
					<label class="col-lg-1 control-label">Reprogramación 1</label>
					...
					<label class="col-lg-1 control-label">Causa</label>
					<div class="col-lg-2">
						<select name="CDU_CausaReprogramacion1" class="form-control m-b" id="CDU_CausaReprogramacion1" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
							<option value="">Seleccione...</option>
				...
				<div class="form-group">
					<label class="col-lg-1 control-label">Reprogramación 2</label>
					<div class="col-lg-2 input-group date">
					...
					<?php $SQL_CausaReprog=Seleccionar('uvw_Sap_tbl_LlamadasServiciosReprogramacion','*','','DeReprogramacion'); ?>
						<select name="CDU_CausaReprogramacion2" class="form-control m-b" id="CDU_CausaReprogramacion2" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
							<option value="">Seleccione...</option>
						 <?php while($row_CausaReprog=sqlsrv_fetch_array($SQL_CausaReprog)){?>
				...
				<div class="form-group">
					<label class="col-lg-1 control-label">Reprogramación 3</label>
					<div class="col-lg-2 input-group date">
					...
					<div class="col-lg-2">
					<?php $SQL_CausaReprog=Seleccionar('uvw_Sap_tbl_LlamadasServiciosReprogramacion','*','','DeReprogramacion'); ?>
						<select name="CDU_CausaReprogramacion3" class="form-control m-b" id="CDU_CausaReprogramacion3" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
							<option value="">Seleccione...</option>
						  <?php while($row_CausaReprog=sqlsrv_fetch_array($SQL_CausaReprog)){?>
				...
				<div class="form-group">
					<label class="col-xs-12"><h3 class="bg-muted p-xs b-r-sm"><i class="fa fa-check-circle"></i> Cierre de llamada</h3></label>
				</div>
					<div class="form-group">
						<label class="col-lg-1 control-label">Resolución de llamada</label>
						<div class="col-lg-8">
							<textarea name="ResolucionLlamada" rows="5" type="text" required="required" class="form-control" id="ResolucionLlamada" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "readonly='readonly'";}?>><?php if(($type_llmd==1)||($sw_error==1)){echo $row['ResolucionLlamada'];}?></textarea>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<?php while($row_AnexoLlamada=sqlsrv_fetch_array($SQL_AnexoLlamada)){
							 ...
							 ?>
							<li><a href="attachdownload.php?file=<?php echo base64_encode($row_AnexoLlamada['AbsEntry']);?>&line=<?php echo base64_encode($row_AnexoLlamada['Line']);?>" target="_blank" class="btn-link btn-xs"><i class="<?php echo $Icon;?>"></i> <?php echo $row_AnexoLlamada['NombreArchivo'];?></a></li>
						<?php }?>
						 </ul>
						</div>
					</div>
				   ...
				   <div class="form-group">
					   <br>
						<div class="col-lg-9">
							...
							<?php }?>
							<?php if(isset($_GET['return'])){$return=base64_decode($_GET['pag'])."?".base64_decode($_GET['return']);}else{$return="gestionar_llamadas_servicios.php";}?>
			   ...
			   <?php if($type_llmd==1){?>
				  	<div class="form-group">
						<label class="col-lg-12"><h3 class="bg-muted p-xs b-r-sm"><i class="fa fa-pencil-square-o"></i> Seguimiento de llamada</h3></label>
					</div>	
										...
										<?php while($row_Actividad=sqlsrv_fetch_array($SQL_Actividad)){ 
											...
											?>
											 <tr class="gradeX">
												...
												<td <?php if($row_Actividad['IdEstadoActividad']=='N'){echo "class='text-success'";}else{echo "class='text-danger'";}?>><?php echo $row_Actividad['DeEstadoActividad'];?></td>
												<td><a href="actividad.php?tl=1&id=<?php echo base64_encode($row_Actividad['ID_Actividad']);?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']);?>&pag=<?php echo base64_encode('llamada_servicio.php');?>" class="alkin btn btn-link btn-xs"><i class="fa fa-folder-open-o"></i> Abrir</a></td>
											</tr>
										<?php }?>
										</tbody>
                    				</table>
									...
									<table class="table table-striped table-bordered table-hover dataTables-example" >
										...
										<?php while($row_DocRel=sqlsrv_fetch_array($SQL_DocRel)){ ?>
											 <tr class="gradeX">
												...
												<td <?php if($row_DocRel['Cod_Estado']=='O'){echo "class='text-success'";}else{echo "class='text-danger'";}?>><?php echo $row_DocRel['NombreEstado'];?></td>
												<td><?php echo $row_DocRel['Usuario'];?></td>
												<td>
												<?php if($row_DocRel['Link']!=""){?>
													<a href="<?php echo $row_DocRel['Link'];?>.php?id=<?php echo base64_encode($row_DocRel['DocEntry']);?>&id_portal=<?php echo base64_encode($row_DocRel['IdPortal']);?>&tl=1&return=<?php echo base64_encode($_SERVER['QUERY_STRING']);?>&pag=<?php echo base64_encode('llamada_servicio.php');?>" class="btn btn-link btn-xs"><i class="fa fa-folder-open-o"></i> Abrir</a>
												<?php }?>
												<?php if($row_DocRel['Link']!=""&&$row_DocRel['Descargar']!=""){echo "-";}?>
												<?php if($row_DocRel['Descargar']!=""){?>
													<a href="sapdownload.php?id=<?php echo base64_encode('15');?>&type=<?php echo base64_encode('2');?>&DocKey=<?php echo base64_encode($row_DocRel['DocEntry']);?>&ObType=<?php echo base64_encode($row_DocRel['IdObjeto']);?>&IdFrm=<?php echo base64_encode($row_DocRel['IdFormato']);?>" target="_blank" class="btn btn-link btn-xs"><i class="fa fa-download"></i> Descargar</a>
												<?php }?>
												</td>
											</tr>
										<?php }?>
									...
									<table class="table table-striped table-bordered table-hover dataTables-example" >
										...
										<?php while($row_FrmHallazgos=sqlsrv_fetch_array($SQL_FrmHallazgos)){ ?>
											 <tr class="gradeX">
												...
												<td><a href="frm_hallazgos.php?id=<?php echo base64_encode($row_FrmHallazgos['ID_Frm']);?>&tl=1&return=<?php echo base64_encode($_SERVER['QUERY_STRING']);?>&pag=<?php echo base64_encode('llamada_servicio.php');?>&frm=<?php echo base64_encode("136");?>" class="alkin btn btn-link btn-xs"><i class="fa fa-folder-open-o"></i> Editar</a> - <a href="sapdownload.php?id=<?php echo base64_encode('13');?>&type=<?php echo base64_encode('2');?>&DocKey=<?php echo base64_encode($row_FrmHallazgos['ID_Frm']);?>" target="_blank" class="btn btn-link btn-xs"><i class="fa fa-download"></i> Descargar</a></td>
											</tr>
										<?php }?>
										</tbody>
                    				</table>
