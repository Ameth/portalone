...
if(isset($_GET['BuscarDatoArt'])&&$_GET['BuscarDatoArt']!=""){
	$Filtro="Where (ItemCode LIKE '%".$_GET['BuscarDatoArt']."%' OR ItemName LIKE '%".$_GET['BuscarDatoArt']."%' OR FrgnName LIKE '%".$_GET['BuscarDatoArt']."%' OR CodigoCliente LIKE '%".$_GET['BuscarDatoArt']."%' OR NombreCliente LIKE '%".$_GET['BuscarDatoArt']."%' OR DireccionSucursal LIKE '%".$_GET['BuscarDatoArt']."%' OR CDU_ContratoNo LIKE '%".$_GET['BuscarDatoArt']."%' OR CDU_IdAutTecnologia LIKE '%".$_GET['BuscarDatoArt']."%')";
			...
			<div class="table-responsive">
                    ...
                    <?php while($row=sqlsrv_fetch_array($SQL)){ ?>
						 <tr class="gradeX">
								...
								<td><?php echo $row['CDU_DeTipoTecnologia'];?></td>
								<td><?php echo $row['CDU_IdAutTecnologia'];?></td>
							 	...
							 	<td <?php if($row['CDU_EstadoServicio']=='Y'){echo "class='text-success'";}else{echo "class='text-danger'";}?>><?php echo $row['CDU_NomEstadoServicio'];?></td>
