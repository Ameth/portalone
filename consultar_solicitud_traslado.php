...
$Cons="Select * From uvw_Sap_tbl_SolicitudesSalidas Where (DocDate Between '$FechaInicial' and '$FechaFinal') $Filtro Order by DocNum DESC";
//echo $Cons;
         ...
         <div class="wrapper wrapper-content">
             <div class="row">
			    <div class="ibox-content">
				  ...
				  <form action="consultar_solicitud_traslado.php" method="get" id="formBuscar" class="form-horizontal">
