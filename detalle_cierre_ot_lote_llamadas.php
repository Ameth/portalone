...
<form id="from" name="form">
	...
	<table width="100%" class="table table-bordered">
		...
		<tr>
			...
			<td><span class="<?php if($row['Integracion']==0){echo "badge badge-warning";}elseif($row['Integracion']==2){echo "badge badge-danger";}else{echo "badge badge-primary";}?>"><?php echo $row['Ejecucion'];?></span></td>
		</tr>	
		<?php 
			$i++;}
		}
