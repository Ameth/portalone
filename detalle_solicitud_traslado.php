...
if(isset($_GET['id'])&&($_GET['id']!="")){
	...
	if($type==1){//Creando Solicitud de traslado
	...
	}else{//Editando Solicitud de traslado
			...
			list: {
				...
				onClickEvent: function() {
					...
					$.ajax({
						...
						<?php }?>
						success: function(response){
							window.location.href="detalle_solicitud_traslado.php?<?php echo $_SERVER['QUERY_STRING'];?>";
						}
					});
				}
			}
