				...
				while($i<$Count){
					if($_POST['Address'][$i]!=""){
						...
						$ParamInsDir=array(
							...
							"'".$_POST['LineNum'][$i]."'",
							"'".$_POST['DirNombreContacto'][$i]."'",
							"'".$_POST['DirCargoContacto'][$i]."'",
							"'".$_POST['DirTelefonoContacto'][$i]."'",
							"'".$_POST['DirCorreoContacto'][$i]."'",
							"'".$_POST['Metodo'][$i]."'",
							"1"
						);
						   ...
						   <div class="tab-content">
							   <div id="tabSN-1" class="tab-pane active">
								   <br>
									...
									<div class="form-group">
										<label class="col-lg-1 control-label">Nombre comercial <span class="text-danger">*</span></label>
										<div class="col-lg-3">
							   ...
							   <div id="tabSN-2" class="tab-pane">
									<br>
										<?php $Cont=1;
										if(($edit==1||$sw_error==1)&&$Num_Cont>0){
										...
										<div class="form-group">
											...
											<label class="col-lg-1 control-label">Apellidos <span class="text-danger">*</span></label>
											<div class="col-lg-3">
										...
										<div class="form-group">
											<label class="col-lg-1 control-label">Cédula <span class="text-danger">*</span></label>
											<div class="col-lg-3">
												<input type="text" onChange="CambiarMetodoCtc('<?php echo $Cont;?>');" class="form-control" maxlength="15" onKeyPress="return justNumbers(event,this.value);" name="CedulaContacto[]" id="CedulaContacto<?php echo $Cont;?>" value="<?php echo $row_Cont['CedulaContacto'];?>" required>
											</div>
											<label class="col-lg-1 control-label">Teléfono <span class="text-danger">*</span></label>
											<div class="col-lg-3">
										...
										<div class="form-group">
											<label class="col-lg-1 control-label">Actividad económica <span class="text-danger">*</span></label>
											<div class="col-lg-3">
											...
											<label class="col-lg-1 control-label">Rep. Legal <span class="text-danger">*</span></label>
											<div class="col-lg-3">
											...
											<div class="col-lg-3">
												...
												<div id="spinEmail<?php echo $Cont;?>" style="display: none;" class="sk-spinner sk-spinner-wave">
													<div class="sk-rect1"></div>
													<div class="sk-rect2"></div>
													<div class="sk-rect3"></div>
													<div class="sk-rect4"></div>
												...
												<div id="ValEmail<?php echo $Cont;?>"></div>
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-1 control-label">Cargo/Vínculo <span class="text-danger">*</span></label>
											<div class="col-lg-3">
											...
											<div class="col-lg-3">
												<select name="EstadoContacto[]" id="EstadoContacto<?php echo $Cont;?>" class="form-control">
													<option value="Y" <?php if($row_Cont['Estado']=='Y'){echo "selected=\"selected\"";}?>>Activo</option>
													<option value="N" <?php if($row_Cont['Estado']=='N'){echo "selected=\"selected\"";}?>>Inactivo</option>
												</select>
											</div>											
										</div>
							   ...
							   <div id="tabSN-3" class="tab-pane">
									<br>
										<?php $Cont=1;
										if(($edit==1||$sw_error==1)&&$Num_Dir>0){
										...
										<div id="div_<?php echo $Cont;?>" class="bg-muted p-sm m-t-md">
											<div class="form-group">
												...
												<label class="col-lg-1 control-label">Nombre dirección <span class="text-danger">*</span></label>
												<div class="col-lg-4">
													<input name="Address[]" type="text" required class="form-control" id="Address<?php echo $Cont;?>" onChange="CambiarMetodo('<?php echo $Cont;?>');" value="<?php echo $row_Dir['NombreSucursal'];?>" maxlength="50">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">													
												...
												<label class="col-lg-1 control-label">Código postal <span class="text-danger">*</span></label>
												<div class="col-lg-4">
											...
											<div class="form-group">													
												<label class="col-lg-1 control-label">Nombre contacto <span class="text-danger">*</span></label>
												<div class="col-lg-4">
													<input name="DirNombreContacto[]" onChange="CambiarMetodo('<?php echo $Cont;?>');" type="text" required class="form-control" id="DirNombreContacto<?php echo $Cont;?>" maxlength="100" value="<?php echo utf8_encode($row_Dir['NombreContacto']);?>">
												</div>
												<label class="col-lg-1 control-label">Cargo contacto <span class="text-danger">*</span></label>
												<div class="col-lg-4">
													<input name="DirCargoContacto[]" onChange="CambiarMetodo('<?php echo $Cont;?>');" type="text" required class="form-control" id="DirCargoContacto<?php echo $Cont;?>" maxlength="100" value="<?php echo utf8_encode($row_Dir['CargoContacto']);?>">
												</div>
											</div>
											<div class="form-group">													
												<label class="col-lg-1 control-label">Teléfono contacto <span class="text-danger">*</span></label>
												<div class="col-lg-4">
													<input name="DirTelefonoContacto[]" onChange="CambiarMetodo('<?php echo $Cont;?>');" type="text" required class="form-control" id="DirTelefonoContacto<?php echo $Cont;?>" maxlength="100" value="<?php echo utf8_encode($row_Dir['TelefonoContacto']);?>">
												</div>
												<label class="col-lg-1 control-label">Correo contacto <span class="text-danger">*</span></label>
												<div class="col-lg-4">
													<input name="DirCorreoContacto[]" onChange="CambiarMetodo('<?php echo $Cont;?>');" type="text" required class="form-control" id="DirCorreoContacto<?php echo $Cont;?>" maxlength="254" value="<?php echo utf8_encode($row_Dir['CorreoContacto']);?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-1 control-label">Dirección del contrato <span class="text-danger">*</span></label>
												<div class="col-lg-2">
													<select name="DirContrato[]" id="DirContrato<?php echo $Cont;?>" class="form-control" required onChange="CambiarMetodo('<?php echo $Cont;?>');">
														<option value="0" <?php if($row_Dir['DirContrato']=='0'){echo "selected=\"selected\"";}?>>NO</option>
														<option value="1" <?php if($row_Dir['DirContrato']=='1'){echo "selected=\"selected\"";}?>>SI</option>
													</select>
												</div>
											</div>
										...
										<div id="div_<?php echo $Cont;?>" class="bg-muted p-sm m-t-md">
											...
											<div class="form-group">													
												<label class="col-lg-1 control-label">Nombre contacto <span class="text-danger">*</span></label>
												<div class="col-lg-4">
													<input name="DirNombreContacto[]" type="text" required class="form-control" id="DirNombreContacto<?php echo $Cont;?>" maxlength="100">
												</div>
												<label class="col-lg-1 control-label">Cargo contacto <span class="text-danger">*</span></label>
												<div class="col-lg-4">
													<input name="DirCargoContacto[]" type="text" required class="form-control" id="DirCargoContacto<?php echo $Cont;?>" maxlength="100">
												</div>
											</div>
											<div class="form-group">													
												<label class="col-lg-1 control-label">Teléfono contacto <span class="text-danger">*</span></label>
												<div class="col-lg-4">
													<input name="DirTelefonoContacto[]" type="text" required class="form-control" id="DirTelefonoContacto<?php echo $Cont;?>" maxlength="100">
												</div>
												<label class="col-lg-1 control-label">Correo contacto <span class="text-danger">*</span></label>
												<div class="col-lg-4">
													<input name="DirCorreoContacto[]" type="text" required class="form-control" id="DirCorreoContacto<?php echo $Cont;?>" maxlength="254">
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-1 control-label">Dirección del contrato <span class="text-danger">*</span></label>
										...
										<?php if($edit==1||$sw_error==1){?><button type="button" id="<?php echo $Cont;?>" class="btn btn-success btn-xs" onClick="addField(this);"><i class="fa fa-plus"></i> Añadir otro</button><?php }?>
										<br><br>
										</div>
								   		<?php if($edit==0&&$sw_error==0){
											$Cont++;?>
											...
											<div class="form-group">
												...
												<div class="col-lg-4">
												  <select name="AdresType[]" id="AdresType<?php echo $Cont;?>" class="form-control" required>
														...
														<option value="S" selected>DIRECCIÓN DE ENVÍO</option>
													</select>
												</div>
												<label class="col-lg-1 control-label">Nombre dirección <span class="text-danger">*</span></label>
												<div class="col-lg-4">
						...
						<table class="table table-striped table-bordered">
							...
							<?php while($row_FactPend=sqlsrv_fetch_array($SQL_FactPend)){?>
								 <tr>
									...
									<td><a href="sapdownload.php?id=<?php echo base64_encode('15');?>&type=<?php echo base64_encode('2');?>&DocKey=<?php echo base64_encode($row_FactPend['NoInterno']);?>&ObType=<?php echo base64_encode('13');?>&IdFrm=<?php echo base64_encode($row_FactPend['Series']);?>" target="_blank" class="btn btn-warning btn-xs"><i class="fa fa-download"></i> Descargar</a></td> 
...
//	}
	...
	for(var i=0;i<NomDireccion.length;i++){
		if(NomDireccion[i].value!=''){
			...
			var Address=document.getElementById("Address"+DirID);
