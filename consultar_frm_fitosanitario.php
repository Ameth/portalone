...
<title>Monitoreo de estado fitosanitario | <?php echo NOMBRE_PORTAL;?></title>
<!-- InstanceEndEditable -->
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-8">
                    <h2>Monitoreo de estado fitosanitario</h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Monitoreo de estado fitosanitario</strong>
                        </li>
                    </ol>
                </div>			
            </div>
