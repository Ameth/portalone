...
if(isset($_GET['dt_LS'])&&($_GET['dt_LS'])==1){//Verificar que viene de una Llamada de servicio (Datos Llamada servicio)
	...
	//Sucursal cliente
	$SQL_SucursalCliente=Seleccionar('uvw_Sap_tbl_Clientes_Sucursales','*',"CodigoCliente='".base64_decode($_GET['Cardcode'])."'",'TipoDireccion, NombreSucursal');
}

if($type_llmd==1&&$sw_error==0){
	//Llamada
	$SQL=Seleccionar('uvw_Sap_tbl_LlamadasServicios_DatosMaestros','*',"ID_LlamadaServicio='".$IdLlamada."'");
           ...
           <div class="col-lg-12">
              <form action="llamada_servicio.php" method="post" class="form-horizontal" enctype="multipart/form-data" id="CrearLlamada">
				...
				<div class="ibox">
					...
					<div class="ibox-content">
						<div class="form-group">
							<label class="col-lg-1 control-label">Categoria origen <span class="text-danger">*</span></label>
							<div class="col-lg-3">
								<select name="CategoriaOrigen" class="form-control" id="CategoriaOrigen" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?> required>
									<option value="">Seleccione...</option>
								  <?php while($row_CatOrigen=sqlsrv_fetch_array($SQL_CatOrigen)){?>
										<option value="<?php echo $row_CatOrigen['IdCateOrigenLlamada'];?>" <?php if((isset($row['IdCateOrigenLlamada']))&&(strcmp($row_CatOrigen['IdCateOrigenLlamada'],$row['IdCateOrigenLlamada'])==0)){ echo "selected=\"selected\"";}?>><?php echo $row_CatOrigen['DeCateOrigenLlamada'];?></option>
								  <?php }?>
								</select>
							</div>
							<label class="col-lg-2 control-label">Indisponibilidad <span class="text-danger">*</span></label>
							<div class="col-lg-2">
								<select name="Indisponibilidad" class="form-control" required id="Indisponibilidad" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
										<option value="">Seleccione...</option>
								  <?php while($row_IndispoLlamada=sqlsrv_fetch_array($SQL_IndispoLlamada)){?>
										<option value="<?php echo $row_IndispoLlamada['IdIndispoLlamada'];?>" <?php if((isset($row['IdIndispoLlamada']))&&(strcmp($row_IndispoLlamada['IdIndispoLlamada'],$row['IdIndispoLlamada'])==0)){ echo "selected=\"selected\"";}?>><?php echo $row_IndispoLlamada['DeIndispoLlamada'];?></option>
								  <?php }?>
								</select>
							</div>
							<label class="col-lg-2 control-label">Responsabilidad <span class="text-danger">*</span></label>
							<div class="col-lg-2">
								<select name="Responsabilidad" class="form-control" required id="Responsabilidad" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
										<option value="">Seleccione...</option>
								  <?php while($row_ResponLlamada=sqlsrv_fetch_array($SQL_ResponLlamada)){?>
										<option value="<?php echo $row_ResponLlamada['IdResponLlamada'];?>" <?php if((isset($row['IdResponLlamada']))&&(strcmp($row_ResponLlamada['IdResponLlamada'],$row['IdResponLlamada'])==0)){ echo "selected=\"selected\"";}?>><?php echo $row_ResponLlamada['DeResponLlamada'];?></option>
								  <?php }?>
								</select>
							</div>
						</div>
				...
				<div class="ibox">
					...
					<div class="ibox-content">
						...
						<div class="form-group">
							...
							<div class="col-lg-3">
								<select name="TipoResolucion" class="form-control" id="TipoResolucion" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
									<option value="">Seleccione...</option>
								  <?php while($row_ResolucionLlamada=sqlsrv_fetch_array($SQL_ResolucionLlamada)){?>
										<option value="<?php echo $row_ResolucionLlamada['IdTipoResolucionLlamada'];?>" <?php if((isset($row['IdTipoResolucionLlamada']))&&(strcmp($row_ResolucionLlamada['IdTipoResolucionLlamada'],$row['IdTipoResolucionLlamada'])==0)){ echo "selected=\"selected\"";}?>><?php echo $row_ResolucionLlamada['DeTipoResolucionLlamada'];?></option>
								  <?php }?>
								</select>
							</div>
							<label class="col-lg-1 control-label">Estado servicio <span class="text-danger">*</span></label>
							<div class="col-lg-3">
								<select name="EstadoServicio" class="form-control" required id="EstadoServicio" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
										<option value="">Seleccione...</option>
								  <?php while($row_EstServLlamada=sqlsrv_fetch_array($SQL_EstServLlamada)){?>
										<option value="<?php echo $row_EstServLlamada['IdEstadoServicioLlamada'];?>" <?php if((isset($row['IdEstadoServicioLlamada']))&&(strcmp($row_EstServLlamada['IdEstadoServicioLlamada'],$row['IdEstadoServicioLlamada'])==0)){ echo "selected=\"selected\"";}?>><?php echo $row_EstServLlamada['DeEstadoServicioLlamada'];?></option>
								  <?php }?>
								</select>
							</div>
							<label class="col-lg-1 control-label">Cancelado por <span class="text-danger">*</span></label>
							<div class="col-lg-3">
								<select name="CanceladoPor" class="form-control" required id="CanceladoPor" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
								  <?php while($row_CancelarLlamada=sqlsrv_fetch_array($SQL_CancelarLlamada)){?>
										<option value="<?php echo $row_CancelarLlamada['IdCancelarLlamada'];?>" <?php if((isset($row['IdCancelarLlamada']))&&(strcmp($row_CancelarLlamada['IdCancelarLlamada'],$row['IdCancelarLlamada'])==0)){ echo "selected=\"selected\"";}?>><?php echo $row_CancelarLlamada['DeCancelarLlamada'];?></option>
								  <?php }?>
								</select>
							</div>
						</div>
					...
					<div class="ibox-content">	
						<div class="tabs-container">
							<ul class="nav nav-tabs">
								...
								<li><a data-toggle="tab" href="#tab-4" <?php if($row['LatitudGPS']!=""&&$row['LongitudGPS']!=""){?>onClick="start_map(<?php echo $row['LatitudGPS'];?>,<?php echo $row['LongitudGPS'];?>);"<?php }?>><i class="fa fa-map-marker"></i> Ubicación GPS</a></li>
							</ul>
...
-->
							...
							<div id="tab-4" class="tab-pane">
								<div class="panel-body">
									<div class="google-map" id="map"><?php if($row['LatitudGPS']==""||$row['LongitudGPS']==""){echo "No hay datos para mostrar.";}?></div>
								</div>
							</div>
						</div>
				  		</div>	
...
<script>
	 $(document).ready(function(){
		 ...
		 $('#FechaCierre').datepicker({
				...
				format: 'yyyy-mm-dd',
			 	todayHighlight: true,
			 	startDate: '<?php echo $row['FechaCreacionLLamada']->format('Y-m-d');?>',
