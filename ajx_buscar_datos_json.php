...
//			'DeOLT' => $row['DeOLT']
	...
	elseif($type==40){//Consultar datos del cliente
		$SQL=Seleccionar("uvw_Sap_tbl_Clientes","
		DirDestino,CodPostalDestino,CiudadDestino,CodDepartamentoDestino,DepartamentoDestino,PaisDestino,Telefono","CodigoCliente='".$_GET['id']."'");
		$records=array();
		$row=sqlsrv_fetch_array($SQL);
		$records=array(
