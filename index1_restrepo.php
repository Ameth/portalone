										...
										<table class="table table-striped table-bordered table-hover dataTables-example" >
											...
											<?php while($row_MisAct=sqlsrv_fetch_array($SQL_MisAct)){
												...
												<tr class="gradeX">
													...
													<td><?php echo $row_MisAct['FechaCreacion']->format('Y-m-d');?></td>
													...
													<td><a href="actividad.php?id=<?php echo base64_encode($row_MisAct['ID_Actividad']);?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']);?>&pag=<?php echo base64_encode('index1.php');?>" class="btn btn-link btn-xs"><i class="fa fa-folder-open-o"></i> Abrir</a></td>
												</tr>
											<?php }?>
											</tbody>
										</table>
										...
										<table class="table table-striped table-bordered table-hover dataTables-example" >
											...
											<?php while($row_ActAsig=sqlsrv_fetch_array($SQL_ActAsig)){
												...
												<tr class="gradeX">
													...
													<td><?php echo $row_ActAsig['FechaCreacion']->format('Y-m-d');?></td>
													...
													<td><a href="actividad.php?id=<?php echo base64_encode($row_ActAsig['ID_Actividad']);?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']);?>&pag=<?php echo base64_encode('index1.php');?>" class="btn btn-link btn-xs"><i class="fa fa-folder-open-o"></i> Abrir</a></td>
												</tr>
											<?php }?>
											</tbody>
										</table>
